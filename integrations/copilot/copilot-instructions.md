...
evidence as the starting context. Do not repeat searches or reopen the same files unless Athena
reports low confidence or missing evidence. Keep responses concise and stop after the requested
change and verification. Do not call Athena for general questions that do not require repository
context.
